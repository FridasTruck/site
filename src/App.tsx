...
import BlogGridLeftSidebar from "./pages/BlogGridLeftSideba";
...
const AuthenticatedRoute: React.FC = () => {
  ...
  if (isValidToken === null) {
    ...
    return null; // Render a loading indicator here if needed
  }
  ...
  console.log("Token valid, rendering MenuStyle5");
  return <MenuStyle5 />;
};
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route element={<Layout4 />}>
              ...
              <Route path="/our-menu-5" element={<AuthenticatedRoute />} />
              ...
              <Route path="/blog-grid-3-masonary" element={<BlogGrid3Masonary />} />
              <Route path="/blog-grid-4-masonary" element={<BlogGrid4Masonary />} />
              <Route path="/blog-wide-list-sidebar" element={<BlogWideListSidebar />} />
              <Route path="/blog-wide-grid-sidebar" element={<BlogWideGridSidebar />} />
            ...
            <Route element={<Layout6 />}>
              ...
              <Route path="/blog-detail-left-sidebar" element={<BlogDetailLeftSidebar />} />
              <Route path="/blog-detail-right-sidebar" element={<BlogDetailRightSidebar />} />
            </Route>
