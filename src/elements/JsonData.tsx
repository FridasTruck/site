...
export const Home3ServicesArr = [
  { icon: "flaticon-chef", content: "O Melhor Chef" },
  { icon: "flaticon-pot", content: "Temos o Produto de Maior Qualidade" },
];
...
export const AboutServiceArr = [
  { icon: "flaticon-vegetable", title: "Produtos Frescos" },
  { icon: "flaticon-chef-hat", title: "Pratos Deliciosos" },
  { icon: "flaticon-cocktail", title: "Bebidas Refrescantes" },
  { icon: "flaticon-cuisine", title: "Sabores Únicos" },
];
